...
// The four brand benefits shown in the bar below the hero
const BENEFITS = [
  {
    icon: Award,
...
// Benefits — horizontal bar with 4 brand pillars
export default function Benefits() {
  const shouldReduce = useReducedMotion()

  // Staggered reveal animation — items fade in one by one as they scroll into view
