...
function InstagramIcon({ className, strokeWidth = 1.5 }) {
  return (
...
function FacebookIcon({ className, strokeWidth = 1.5 }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round">
...
function YoutubeIcon({ className, strokeWidth = 1.5 }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round">
...
// Small reusable component for a single footer link
...
export default function Footer() {
  // Track email input and subscription state for the newsletter form
  ...
  // Animation: columns fade in one by one as you scroll to the footer
