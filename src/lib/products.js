// ============================================
// DRAVE — Product Data
// Plain JavaScript objects and arrays — no TypeScript types needed
// ============================================

// All products as a simple JavaScript array
...
export const COLLECTIONS = [
  ...
  },
  {
    ...
    slug: 'limited-drops',
    name: 'Limited Drops',
    tagline: 'Exclusive pieces. No restocks.',
    description: 'Exclusive limited-run pieces crafted with bespoke detailing. No restocks. Ever.',
...
// TODO: Replace these with real API/MongoDB calls when ready
// ============================================
...
// Find a single product by its slug (the URL-friendly name)
export async function getProduct(slug) {
  return PRODUCTS.find((p) => p.slug === slug) ?? null
}

// Get the bestselling products (up to 4)
